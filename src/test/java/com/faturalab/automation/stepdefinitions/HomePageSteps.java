...
public class HomePageSteps {
    ...
    // ⚠️ 2026-09-04: lazy init — Cucumber bu sınıfı glue'ya giren HER senaryoda (hangi step'in
    // eşleşeceğinden bağımsız, hook'lardan bile önce) örnekliyor. Eskiden constructor'da eager
    // DriverManager.getDriver() çağrısı, saf @api senaryolarında bile gereksiz bir Chrome açıyordu
    // (doğrulandı: günlük TestRunner @jsonplaceholder koşumunda bile WebDriver init logu görüldü).
    // Artık driver/homePage sadece bu sınıfın bir step'i gerçekten çağrıldığında oluşuyor.
