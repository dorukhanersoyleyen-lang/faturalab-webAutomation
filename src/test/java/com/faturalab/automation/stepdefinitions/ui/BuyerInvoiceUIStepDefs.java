...
import com.faturalab.automation.utils.UiIntegrationInvoiceUploader;
 ...
 * <p>E-fatura için alıcı entegrasyon API adımı: {@code alici entegrasyon API ile E-fatura yükler}.</p>
 */
public class BuyerInvoiceUIStepDefs {
    ...
    /**
     * Tedarikçi değil — yalnızca alıcı (buyer v0) entegrasyon uçları; {@code integration.api.*} + alıcı VKN gerekir.
     */
    @And("alici entegrasyon API ile E-fatura yükler")
    public void aliciEntegrasyonApiEFatura() {
        Assert.assertTrue(UiIntegrationInvoiceUploader.tryUploadSampleEInvoiceAsBuyer(),
                "alici entegrasyon API ile E-fatura yükleme başarısız (integration.api.*, "
                        + "test.matched.buyer.taxno / integration.api.auth.taxno, supplier VKN).");
    }
