...
Feature: E2E Akışlar UAT
  ...
  # E2E: tedarikçi fatura → işlem bekleyenler → teklif talebi (süre + varsa otomatik teklif alınan faturalar)
  # → FK günlük teklif talebi → GÖZAT → teklif formu → tedarikçi gelen teklifte Kabul → FK bordro oluşturma
