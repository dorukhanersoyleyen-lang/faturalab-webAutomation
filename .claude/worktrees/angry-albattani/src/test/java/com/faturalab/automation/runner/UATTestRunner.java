 ...
 *
 * Çalıştırma:
 *   mvn test -Denv=dev2 -Dcucumber.filter.tags="@uat and not @disabled"
 *
 * Sadece kritik senaryolar:
 *   mvn test -Denv=dev2 -Dcucumber.filter.tags="@uat and @kritik"
 *
 * Belirli bir case:
 *   mvn test -Denv=dev2 -Dcucumber.filter.tags="@fl-001"
 *
...
public class UATTestRunner extends AbstractTestNGCucumberTests {
    ...
    public void printReport() {
        System.out.println("[UATTestRunner] UAT test raporu: target/cucumber-reports/uat/index.html");
    }
}
